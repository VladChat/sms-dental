...
| PA-13 | SMS Conversation Builder v1 | platform-admin/sms-conversation-builder.md | platform_admin | internal | OPERATIONS-RUNBOOK.md (2026-06-11), config/sms-recovery.config.ts, lib/sms-recovery/conversation-templates.ts | /admin | Admin-only deterministic SMS flow; locked clinic identity + STOP suffix; editable initial middle; up to 3 follow-ups; max 0–3; conservative patient-name extraction; no AI; owners cannot edit; default-safe (0 auto-replies) |
